...
let accountInBase = "Lazzat"
let passwordInBase = "1234L"
let acc = "lazzat"
let pass = "1234L"

if accountInBase.lowercased() == acc.lowercased() && passwordInBase == pass {
    print("«Вы вошли в систему!» ")
}else{
    print("Пожалуйста, проверьте имя пользователя и пароль и повторите попытку».")
}
...
let searchName = "StepChallenger"

if userName.lowercased() == searchName.lowercased(){
